...
function initSwaggerUi() {
    ...
    swaggerSettings['tagsSorter'] = (a, b) => { const order = ["Authorization", "Users", "Stations"], indexA = order.indexOf(a), indexB = order.indexOf(b); return (indexA === -1 && indexB === -1) ? a.localeCompare(b) : (indexA === -1 ? 1 : (indexB === -1 ? -1 : indexA - indexB)); };
    swaggerSettings['persistAuth'] = true;
